-- Fix existing cash_ledger table structure
-- This adds missing columns to the existing table
...
-- 6. Function to automatically create cash ledger entries for sales
...
-- 7. Trigger to automatically create cash entries for sales
...
-- 8. Function to automatically create cash ledger entries for expenses
...
-- 9. Trigger to automatically create cash entries for expenses
...
-- 10. Function to get financial summary for a date range
...
-- 11. Function to get cash balance at any point in time
...
-- 12. Function to get expense breakdown by category
...
-- 13. Function to get cash flow summary
