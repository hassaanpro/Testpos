...
-- Grant permissions
GRANT EXECUTE ON FUNCTION process_bnpl_payment_new(TEXT, NUMERIC) TO authenticated;

-- Test the new function
SELECT * FROM process_bnpl_payment_new('f29bc7eb-86d1-4e84-b657-032bc6a5fc12', 100.00); 