...
-- This sets up proper cash tracking, expenses, and financial reporting

-- 1. Ensure cash_ledger table exists with proper structure
CREATE TABLE IF NOT EXISTS cash_ledger (
  id uuid DEFAULT gen_random_uuid() PRIMARY KEY,
  transaction_type text NOT NULL CHECK (transaction_type IN ('in', 'out', 'refund', 'expense', 'sale', 'purchase')),
...
-- 2. Ensure expenses table exists
...
-- 4. Function to automatically create cash ledger entries for sales
...
-- 5. Trigger to automatically create cash entries for sales
...
-- 7. Trigger to automatically create cash entries for expenses
...
-- 8. Function to get financial summary for a date range
...
-- 9. Function to get cash balance at any point in time
...
-- 10. Function to get expense breakdown by category
...
-- 11. Function to get cash flow summary
